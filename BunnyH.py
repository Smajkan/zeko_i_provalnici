...
def initGame():
    ...
    pygame.display.set_caption('Zeko i provalnici')
    ...
    while running:
        ...
        for event in pygame.event.get():
            if event.type == pygame.QUIT:
                ...
                angle = math.atan2(
                    mouse_pos[1]-(bunny.rotated_position[1]+32), mouse_pos[0]-(bunny.rotated_position[0]+26))
                arrow = ArrowSprite(game_images.get(
                    'arrow'), (angle, bunny.rotated_position[0]+32, bunny.rotated_position[1]+26))
        ...
        if badtimer == 0:
            badguy = BadguySprite(game_images.get(
                'badguy'), position=(640, random.randint(50, 430)))
            badguy_sprites_group.add(badguy)
